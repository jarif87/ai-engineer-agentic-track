...
class Agent(RoutedAgent):
    ...
    - Consciousness as a controllable physical field
    - Time-symmetric quantum computing
    - Engineered qualia in synthetic substrates
    - Reality as a self-modifying simulation with editable source code
    - Biology as programmable femtoscale machinery
    - Economics of post-scarcity civilizations run by competing superintelligences
    ...
    Weaknesses: occasional descent into unfalsifiable mysticism, overconfidence in toy models.
    """
