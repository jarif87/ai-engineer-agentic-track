...
class EngineeringTeam():
    ...
    def backend_engineer(self) -> Agent:
        return Agent(config=self.agents_config['backend_engineer'],verbose=True,allow_code_execution=False,max_execution_time=500, 
            max_retry_limit=3)
    ...
    def test_engineer(self) -> Agent:
        return Agent(config=self.agents_config['test_engineer'],verbose=True,allow_code_execution=False,max_execution_time=500, 
            max_retry_limit=3)
